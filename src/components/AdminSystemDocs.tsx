              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {expandedSections.cronjob ? (
                    <FiChevronUp className="w-4 h-4 text-white/50" />
                  ) : (
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    title="Copiar email"
                  >
                    <FiCopy className="w-3 h-3 text-white/50" />
                  </button>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-white/20 mt-3">
                ...
                <div className="flex flex-col gap-3 text-sm">
                  <div className="bg-white/5 rounded p-3">
                    ...
                    <p className="text-white font-mono">Auto Entries</p>
                  </div>
                  <div className="bg-white/5 rounded p-3">
                  ...
                  <div className="bg-blue-500/10 rounded p-3 border border-blue-500/20">
                    <p className="text-blue-200 font-medium pb-2">
                      Funcionamiento:
                    </p>
                    <div className="flex flex-col gap-2 text-blue-100 text-xs">
                      <p>
                        • Se ejecuta automáticamente cada día a las 00:02 hora
                        Canaria
                      </p>
                      <p>• Busca usuarios con auto_entry_enabled = true</p>
                      <p>
                        • Revisa los últimos 7 días para encontrar días sin
                        registros
                      </p>
                      <p>
                        • Genera entradas/salidas aleatorias para días
                        laborables
                      </p>
                      <p>
                        • Respeta días libres configurados en user_work_settings
                      </p>
                      <p>
                        • Crea breaks aleatorios para hacer el día más realista
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 text-sm">
                  ...
                  <div className="bg-white/5 rounded p-3">
                    ...
                    <div className="flex flex-col gap-1 text-white font-mono text-xs">
                      ...
                      <p>• daily-entries - Generación automática de entradas</p>
                    </div>
                  </div>
                  <div className="bg-green-500/10 rounded p-3 border border-green-500/20">
                    ...
                    <div className="flex flex-col gap-2 text-green-100 text-xs">
                      <p>
          ...
          <div className="bg-white/5 rounded-lg p-4 border border-white/10">
            <div className="flex items-center justify-between pb-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-3 py-1 bg-gray-700 hover:bg-gray-600 text-white text-sm rounded-lg transition-colors"
              >
                Ver Repo
                <FiExternalLink className="w-3 h-3" />
              </a>
                ...
                <div className="flex flex-col gap-3 text-sm">
                  <div className="bg-gray-500/10 rounded p-3 border border-gray-500/20">
                    ...
                    <div className="flex flex-col gap-1 text-gray-100 text-xs">
                      ...
                      <p>• date-fns para manejo de fechas</p>
                      <p>• React Icons para iconografía</p>
                    </div>
                  </div>
                  <div className="bg-gray-500/10 rounded p-3 border border-gray-500/20">
                    <p className="text-gray-200 font-medium pb-2">
                    ...
                    <div className="flex flex-col gap-1 text-gray-100 font-mono text-xs">
                      ...
                      <p>• npm run preview - Preview del build</p>
                    </div>
                  </div>
                </div>
              </div>
