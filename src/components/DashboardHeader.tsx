  ...
  return (
    <header className="bg-blanco border-b border-hielo/30">
      <div className="px-4 py-4 md:px-6 md:py-5 lg:px-10 lg:py-7">
        <div className="flex items-center justify-between md:hidden fade-down opacity-0">
        ...
        {/* Desktop */}
        <div className="hidden md:flex md:items-center md:justify-between fade-down opacity-0">
