...
export function PasswordResetPage({ onResetComplete }: PasswordResetPageProps) {
  ...
  if (isValidSession === null) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-azul-profundo to-teal flex items-center justify-center px-4">
        <div className="flex items-center gap-3 fade-up opacity-0">
  ...
  if (!isValidSession) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-azul-profundo to-teal flex items-center justify-center px-4">
        <div className="flex justify-center fade-up opacity-0">
          <div className="w-full" style={{ maxWidth: "28rem" }}>
            <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-8 shadow-xl text-center">
              ...
              <p className="text-azul-profundo/70 pb-6">
                El enlace de recuperación ha expirado o es inválido. Solicita
                uno nuevo.
              </p>
    ...
    <div className="min-h-screen bg-gradient-to-b from-azul-profundo to-teal flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md">
        <div className="text-center pb-8">
          <h1 className="text-3xl font-bold text-white pb-2 fade-left opacity-0">
            Nueva Contraseña
          </h1>
          <p className="text-white/80 fade-up opacity-0">
