...
export function PasswordUpdatePage({ usuario, onPasswordUpdated }: PasswordUpdatePageProps) {
  ...
  useGSAPAnimations({
    animations: [initLoginAnimations],
    delay: 100
  })
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="login-logo text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-mandarina to-naranja-tostado rounded-2xl mb-4 shadow-2xl">
            <span className="text-2xl font-bold text-blanco">🔒</span>
          </div>
          <h1 className="text-3xl font-bold text-blanco mb-2">Actualizar Contraseña</h1>
        ...
        <div className="login-form bg-blanco/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
          <h2 className="text-2xl font-bold text-azul-profundo mb-4 text-center">
            Primera conexión
          </h2>
          
          <div className="mb-6 p-4 bg-mandarina/10 border border-mandarina/30 rounded-lg">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-mandarina to-naranja-tostado text-blanco py-3 px-4 rounded-lg font-medium hover:shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
            >
              {isLoading ? (
